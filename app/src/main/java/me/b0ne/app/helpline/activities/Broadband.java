        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                case 0:
                    ...
                    intent.setData(Uri.parse("tel:1800-345-1504"));
                    startActivity(intent);
                    break;
                case 1:
                    intent.setData(Uri.parse("tel:+91 80 6638 9385"));
                    startActivity(intent);
                    break;
                case 2:
                    intent.setData(Uri.parse("tel:1800 103 0121 "));
                    startActivity(intent);
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    intent.setData(Uri.parse("tel:1800-266-3030"));
                    startActivity(intent);
                    break;
