...
public class Bank extends ActionBarActivity {
...
//        ActionBar actionBar = getSupportActionBar();
        ...
        String[] items = getResources().getStringArray(R.array.bank_item_list);
